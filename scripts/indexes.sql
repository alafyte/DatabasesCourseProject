CREATE INDEX IDX_LOCATION ON HEAD_ADMIN.RESTAURANT (LOCATION)
    INDEXTYPE IS MDSYS.SPATIAL_INDEX PARAMETERS ('LAYER_GTYPE=POINT CBTREE_INDEX=TRUE');

CREATE INDEX IDX_COVERAGE_AREA
    ON RESTAURANT (COVERAGE_AREA)
...
CREATE INDEX IDX_COURIER_READY_TO_GO ON COURIER (READY_TO_GO);
CREATE INDEX IDX_COURIER_ACTIVE_READY_TO_GO ON COURIER (ACTIVE, READY_TO_GO);
